describe License, :focus => true do
  ...
  describe "renew!" do
    ...
    it "extends expiry by default" do
    ...
    it "extends expiry by override" do
      original_expiry = license_standard.expires
