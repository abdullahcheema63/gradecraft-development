...
json.meta do
  ...
  end if current_course.has_learning_objectives?
  ...
  json.term_for_learning_objectives term_for :learning_objectives if current_course.has_learning_objectives?
  json.term_for_learning_objective term_for :learning_objective if current_course.has_learning_objectives?
