...
class UsersController < ApplicationController
  ...
  def manually_activate
    ...
    respond_to do |format|
      format.html { redirect_to session[:return_to] || overview_index_path, notice: "#{@user.first_name} #{@user.last_name} has been activated!" }
      format.json { head :ok }
    end
  end
  ...
  def activated
    ...
    if @user.update_attributes user_params
      ...
      redirect_to overview_index_path, notice: "Welcome to GradeCraft!" and return
    end
  ...
  def resend_activation_email
    ...
    redirect_to session[:return_to] || overview_index_path, notice: "An Activation Email has been sent to #{@user.name}!"
  end
