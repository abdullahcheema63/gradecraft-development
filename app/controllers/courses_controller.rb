...
class CoursesController < ApplicationController
  ...
  def course_params
    course_attrs = [
      ...
      :user_id, :course_id, :course_rules, :dashboard_message, :delete_student_logged_grade, :syllabus, :remove_syllabus,
      :has_multipliers, :has_character_names, :has_team_roles, :has_character_profiles, :show_analytics,
      :show_grade_predictor, :total_weights, :weights_close_at, :has_public_badges,
